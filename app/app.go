...
import (
	...
	"github.com/dmdv/cosmos-quarts/docs"
)
...
func New(
	...
	*/
	...
	app.CosmosquartsKeeper = *cosmosquartsmodulekeeper.NewKeeper(
		appCodec,
		keys[cosmosquartsmoduletypes.StoreKey],
		keys[cosmosquartsmoduletypes.MemStoreKey],
		app.GetSubspace(cosmosquartsmoduletypes.ModuleName),
	)
